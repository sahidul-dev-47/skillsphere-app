    ...
    >
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-3">
          <button className=" flex-1 bg-gray-900 text-white py-3.5 rounded-2xl text-sm font-bold hover:bg-violet-600 transition-all shadow-lg active:scale-95">
            Buy Now
          </button>
          <Link href={`/courses/${course.id}`} className="flex-1">
            <button className=" w-full bg-gray-50 text-gray-700 py-3.5 rounded-2xl text-sm font-bold hover:bg-gray-100 transition-all border border-gray-100">
              Details
            </button>
          </Link>
        </div>
